<?php // $Id: incl_stud.php,v 1.2 2013/10/09 08:47:50 shtifanov Exp $
/// This file to be included so we can assume config.php has already been included.
	...
	listbox_faculty("student.php?mode=1&amp;gid=$gid&amp;cid=$cid&amp;sid=$sid&amp;fid=", $fid);
    listbox_speciality("student.php?mode=2&amp;gid=$gid&amp;fid=$fid&amp;cid=$cid&amp;sid=", $fid, $sid);
    listbox_curriculum("student.php?mode=3&amp;sid=$sid&amp;fid=$fid&amp;gid=$gid&amp;cid=", $fid, $sid, $cid);
    listbox_group_pegas("student.php?mode=4&amp;cid=$cid&amp;sid=$sid&amp;fid=$fid&amp;gid=", $fid, $sid, $cid, $gid);
    listbox_student("student.php?mode=5&amp;fid=$fid&amp;sid=$sid&amp;cid=$cid&amp;gid=$gid&amp;uid=", $fid, $sid, $cid, $gid, $uid);
	echo '</table>';
