<?php // $Id: synchr_uid.php,v 1.1.1.1 2009/08/21 08:38:46 Shtifanov Exp $
	...
	if ($um->preprocess_files()) {
		...
		$filename = $um->files['userfile']['tmp_name'];
	   	...
	   	// $arr = array((),());
		$tbStudent = array();
		$tbStudent  = xfgetcsv ($fp, 1000, $csv_delimiter);
		// 0 - "idPerson";
		// 1 - "Familia";
		// 2 - "Imia";
		// 3 - "Otchestvo";
		...
		// 18 - "Gruppa";
		// 19 - "FakultetKod"
		if ($tbStudent[0] == 'idPerson' && $tbStudent[1] == 'Familia' && $tbStudent[2] == 'Imia' &&
		    $tbStudent[3] == 'Otchestvo' && $tbStudent[4] == 'DateRojd' && $tbStudent[18] == 'Gruppa' && $tbStudent[19] == 'FakultetKod')  {
			while (!feof ($fp)) {
