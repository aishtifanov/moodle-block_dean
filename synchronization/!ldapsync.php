<?php // $Id: ldapsync.php,v 1.14 2011/11/18 10:34:02 shtifanov Exp $
			...
			if ($astudents = get_records_sql($studentsql))	{
				...
				if ($lstudents = get_records_select('dean_ldap', "group1= '$namegroup' or group2= '$namegroup'", 'lastname'))	{
					...
					foreach ($deanstuds as $username => $deanstud) {
						...
						if ($deanstudsauth[$username] == 'ldap')	{
    ...
    if ($go != 1)	{
	    print_heading($strsynchronization . ' (с данными LDAP-сервера)', 'center', 2);
    } else {
